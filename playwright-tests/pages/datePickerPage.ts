...
export class DatePickerPage extends HelperBase{
    ...
    async selectDaysFromToday(numberOfDaysFromToday: number){
        ...
        const inputValue = await calendarInputField.inputValue();
        console.log('Actual input value:', inputValue);
        console.log('Expected value:', dateToAssert);
    ...
    private async selectDateInTheCalendar(numberOfDaysFromToday: number){
        ...
        await this.page.locator('.day-cell').getByText(expectedDay, {exact: true}).click();
        return dateToAssert;
    };
};